...
describe("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    ...
    const RewarderAttack = await ethers.getContractFactory("RewarderAttack");

    this.rewarderAttack = await RewarderAttack.connect(attacker).deploy(
    ...
    await this.rewarderAttack.connect(attacker).attack();
  });
